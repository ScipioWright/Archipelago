...
east_cxns: Dict[str, Set[str]] = {f"East {region_name}": prefix_vals("East ", cxn_names)
                                  for region_name, cxn_names in noita_connections.items()}
west_cxns: Dict[str, Set[str]] = {f"West {region_name}": prefix_vals("West ", cxn_names)
                                  for region_name, cxn_names in noita_connections.items()}
